 ...
 * 
 */
@WebServiceClient(name = "PhoneServiceService", targetNamespace = "http://app02.webService.qy.cn/", wsdlLocation = "http://127.0.0.1/webService/phoneStore?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PHONESERVICESERVICE_QNAME = new QName("http://app02.webService.qy.cn/", "PhoneServiceService");
